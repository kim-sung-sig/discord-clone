...
$hashCandidate=(-not $baselinePass -and $hashImprovement -ge 0.20 -and $maxErrorByVariant['date_hash'] -le ($maxErrorByVariant['date_range'] * 1.10) -and $lagP95 -lt 2000)
