...
---
> 🧭 [[T159-compose-health-diagnostic-failure-smoke]] · PDCA: [[T159-compose-health-diagnostic-failure-smoke.plan]] → **design** → [[T159-compose-health-diagnostic-failure-smoke.analysis]] → [[T159-compose-health-diagnostic-failure-smoke.report]] → [[T159-compose-health-diagnostic-failure-smoke.feedback]]
