...
---
> 🧭 [[T120-agent-harness-pdca-loop]] · PDCA: [[T120-agent-harness-pdca-loop.plan]] → **design** → [[T120-agent-harness-pdca-loop.analysis]] → [[T120-agent-harness-pdca-loop.report]] → [[T120-agent-harness-pdca-loop.feedback]]
