...
---
> 🧭 [[T08-presence-typing-read-state]] · PDCA: [[T08-presence-typing-read-state.plan]] → [[T08-presence-typing-read-state.design]] → [[T08-presence-typing-read-state.analysis]] → [[T08-presence-typing-read-state.report]] → **feedback**
