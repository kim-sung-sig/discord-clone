...
---
> 🧭 [[T121-admin-cli-bootrun-smoke-test]] · PDCA: **plan** → [[T121-admin-cli-bootrun-smoke-test.design]] → [[T121-admin-cli-bootrun-smoke-test.analysis]] → [[T121-admin-cli-bootrun-smoke-test.report]] → [[T121-admin-cli-bootrun-smoke-test.feedback]]
