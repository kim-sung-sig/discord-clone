...
---
> 🧭 [[T159-compose-health-diagnostic-failure-smoke]] · PDCA: **plan** → [[T159-compose-health-diagnostic-failure-smoke.design]] → [[T159-compose-health-diagnostic-failure-smoke.analysis]] → [[T159-compose-health-diagnostic-failure-smoke.report]] → [[T159-compose-health-diagnostic-failure-smoke.feedback]]
