...
include(":backend:modules:experience")
include(":backend:modules:event")
...
include(":backend:modules:bot")
include(":backend:modules:notification")
...
project(":backend:modules:experience").projectDir = file("backend/modules/experience")
project(":backend:modules:event").projectDir = file("backend/modules/event")
...
project(":backend:modules:bot").projectDir = file("backend/modules/bot")
project(":backend:modules:notification").projectDir = file("backend/modules/notification")
